...
public:
    ...
    __device__ __forceinline__ static constexpr fixnum
    ...
    __device__ __forceinline__ static fixnum
    ...
    __device__ __forceinline__ static void andOperator(fixnum &z, fixnum x, fixnum b)
    {
        z = x & b;
    }
